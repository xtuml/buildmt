...
1. Start an AWS EC2 instance running Ubuntu 18.04 LTS in the US East (N.
   Virginia) region.  
...
5. When the script completes, copy the file `awsconfig` into the
    ...
    * Copy the text from the gray box
      [here](https://docs.google.com/document/d/16iUguxC3uT20UgSO9YvkeP_wm-7pdiRNzZ6cdTt5iO8/edit)
      into this file  
...
8. Install updates.  
9. Reboot the server.
10. Create an image of the server.  
    * A tutorial for this is [here](HOWTO_migrate_build_server.md)  
11. Test the image by running a nightly build.  
